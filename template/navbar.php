<nav class="navbar navbar-dark bg-dark">
    ...
    <nav class="fixed-bottom bg-dark d-flex d-md-none justify-content-around py-2">
        <?php if (isAdmin()): ?>
        <a class="nav-link text-light <?php isActive('admin-drink.php'); ?>" href="admin-drink.php"><i class="bi bi-cup-straw fs-4"></i></a>
        <a class="nav-link text-light <?php isActive('admin-categorie.php'); ?>" href="admin-categorie.php"><i class="bi bi-tags-fill fs-4"></i></a>
        <a class="nav-link text-light <?php isActive('admin-articoli.php'); ?>" href="admin-articoli.php"><i class="bi bi-newspaper fs-4"></i></a>
        <a class="nav-link text-light <?php isActive('admin-utenti.php'); ?>" href="admin-utenti.php"><i class="bi bi-people-fill fs-4"></i></a>
        <a class="nav-link text-light" href="logout.php"><i class="bi bi-box-arrow-right fs-4"></i></a>
        <?php else: ?>
